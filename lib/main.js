...
class wikipedia {
    ...
    /**
     * This method is used to set the language to be used in the Wikipedia URL. This allows you to scrape content from Wikipedia in multiple supported languages.
     *
     * @example
    ...
    /**
     * Use this method if you want to disable 1 type of some results from the generated page content.
     *
     * @example
    ...
    disableType(type) {
        ...
        if (this.#supports.indexOf(type) == -1) throw new Error(`Unsupported content type, only "header", "paragraph" and "list" are supported.`)
        this.#type = type
        return
    }

    /**
     * Use this method if you want to disable many type of some results from the generated page content.
     *
     * @example
    ...
    disableTypes(type) {
        ...
        if (!isSupported) throw new Error(`Unsupported content type, only "header", "paragraph" and "list" are supported.`)
        this.#types = type
        return
    }
}
